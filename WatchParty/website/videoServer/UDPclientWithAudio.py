...
'''
This is the client that is run for the other users connected to a room when a user enters a video link.
The first function launches the client code and runs the functions to receive the audio and video stream.
'''
...
#runClient()                    #This can be uncommented to run the client alone alongside the server file